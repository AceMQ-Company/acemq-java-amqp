...
[![version](https://img.shields.io/badge/version-0.2.7-blue)](https://github.com/AceMQ-Company/acemq-java-amqp/packages)
...
> **Status: `0.2.7`, published.** The public API may still change while the
