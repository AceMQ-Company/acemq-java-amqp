...
[![version](https://img.shields.io/badge/version-0.4.0-blue)](https://github.com/AceMQ-Company/acemq-java-amqp/releases)
...
> **Status: `0.4.0`, published.** The public API may still change while the
