...
[![version](https://img.shields.io/badge/version-0.7.1-blue)](https://github.com/AceMQ-Company/acemq-java-amqp/releases)
...
> **Status: `0.7.1`, published.** The public API may still change while the
