...
[![version](https://img.shields.io/badge/version-0.2.3-blue)](https://github.com/AceMQ-Company/acemq-java-amqp/packages)
...
> **Status: `0.2.3`, published.** The public API may still change while the
