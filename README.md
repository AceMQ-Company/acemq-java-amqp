...
[![version](https://img.shields.io/badge/version-0.7.2-blue)](https://github.com/AceMQ-Company/acemq-java-amqp/releases)
...
> **Status: `0.7.2`, published.** The public API may still change while the
