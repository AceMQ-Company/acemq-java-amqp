...
AceMQ for Java is [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0).
...
integration suite runs against real RabbitMQ 4.x and 3.13 on every commit, and
what it covers is stated plainly in the documentation — including the parts that
are not built yet.
